...
{
    partial class IssueLocalDrivingLicenseForm
    {
        /// <summary>
        ...
        {
            this.licenseInfomations1 = new DVDL_Persentation.License_Information.LocalDrivingLicenseApplicationInfomations();
